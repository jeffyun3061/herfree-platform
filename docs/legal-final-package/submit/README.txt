...
폴더: docs/legal-final-package/submit/   ← 변호사 제출용 PDF (최신본)

(01-checklist.pdf 등이 다른 프로그램에서 열려 있으면 final/ 대신 submit/에 생성됩니다.)
...
09-lawyer-opinion.pdf     법률 검토 의견서 (AI 시뮬레이션·체크 작성본) ※ 변호사 확인 필수
...
→ docs/legal-final-package/submit/ (또는 final/) 에 PDF 생성
