...
$contactModule = ReadUtf8 "frontend/src/domain/site/contact.ts"
...
RequireText "public operator label is explicit" $contactModule "OPERATOR_DISPLAY_NAME\s*=\s*'헤르프리\(유튜브 채널 운영자\)'"
RequireText "public privacy contact department is explicit" $contactModule "PRIVACY_CONTACT_DEPARTMENT\s*=\s*'헤르프리 개인정보 보호 담당'"
RequireText "public privacy contact email is explicit" $contactModule "OPERATOR_CONTACT_EMAIL\s*=\s*'herpfree3@gmail.com'"
RequireText "privacy page publishes operator label" $privacyPage "OPERATOR_DISPLAY_NAME"
RequireText "privacy page publishes privacy contact department" $privacyPage "PRIVACY_CONTACT_DEPARTMENT"
RequireText "privacy policy publishes operator label" $privacyDoc "운영자: 헤르프리\(유튜브 채널 운영자\)"
RequireText "privacy policy publishes privacy contact" $privacyDoc "개인정보 보호 담당: 헤르프리 개인정보 보호 담당"
RequireText "free noncommercial beta boundary is disclosed" $privacyDoc "무료·비영리 베타"
RequireText "free noncommercial beta boundary in terms" $termsDoc "무료·비영리 베타"
