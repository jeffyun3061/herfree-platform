...
운영 도메인 `https://www.herpfree.co.kr`을 기준으로 다음처럼 맞춘다.
...
| 항목 | 값 |
| --- | --- |
| Web 플랫폼 사이트 도메인 | `https://www.herpfree.co.kr` |
| Redirect URI | `https://www.herpfree.co.kr/auth/callback/kakao` |
...
| 항목 | 값 |
| --- | --- |
| 승인된 JavaScript 원본 | `https://www.herpfree.co.kr` |
| 승인된 리디렉션 URI | `https://www.herpfree.co.kr/auth/callback/google` |
...
| 항목 | 값 |
| --- | --- |
| 서비스 URL | `https://www.herpfree.co.kr` |
| Callback URL | `https://www.herpfree.co.kr/auth/callback/naver` |
