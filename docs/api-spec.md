...
| GET | `/api/admin/contents` | 정보글 전체 목록 (노출·숨김 포함) | 관리자 |
...
| PATCH | `/api/admin/contents/{contentId}/visibility` | 정보글 노출 여부 변경 | 관리자 |
| PATCH | `/api/admin/contents/{contentId}/curation` | 정보글 큐레이션 (정렬·고정) | 관리자 |
| DELETE | `/api/admin/contents/{contentId}` | 정보글 삭제 (soft delete) | 관리자 |

### Admin 정보글 목록 Query Parameter
...
| GET | `/api/admin/contents` | 정보글 목록 (`keyword`, `status`, `category`, `page`, `size`) |
| PATCH | `/api/admin/contents/{contentId}` | 정보글 수정 |
| PATCH | `/api/admin/contents/{contentId}/hide` | 정보글 숨김 |
| PATCH | `/api/admin/contents/{contentId}/visibility` | 정보글 노출 여부 |
| PATCH | `/api/admin/contents/{contentId}/curation` | 정보글 큐레이션 (정렬·고정) |
| DELETE | `/api/admin/contents/{contentId}` | 정보글 삭제 |
...
| 정보글 | `/api/admin/contents/{contentId}/curation` | `sortOrder`, `isPinned` |
| 공지 | `/api/admin/notices/{postId}/curation` | `sortOrder`, `isPinned` |

공개 목록: `sort_order DESC` → `created_at DESC`. 공지·정보글은 `is_pinned` 우선.
