      ...
      <main className="page-container max-w-2xl py-8 lg:py-12">
        ...
        <div className="prose-policy mt-8 space-y-7 text-sm leading-relaxed text-cream-foreground">
          ...
          <Section title="제3조 (회원가입과 이용자격)">
            <p>회원이 약관·개인정보처리방침을 확인하고 필수 동의를 완료해 가입 절차를 마치면 이용계약이 성립합니다. 개인일지를 이용하려는 회원은 별도의 민감정보 처리 동의를 추가로 완료해야 합니다. 이메일 또는 카카오·Google·네이버 등 소셜 로그인을 이용할 수 있으며, 소셜 제공자의 약관과 개인정보처리방침도 적용될 수 있습니다.</p>
            <p>서비스는 만 14세 이상만 이용할 수 있습니다. 가입 화면은 생년월일을 저장하지 않고 만 14세 이상 확인을 받습니다.</p>
          </Section>

          <Section title="제4조 (민감정보와 개인일지)">
            <p>개인일지의 증상·투약·수면·스트레스·기분·유발요인·메모 등 건강 관련 값은 민감정보로 취급하며 일반 개인정보와 구분해 별도 동의를 받습니다. 가입 시 동의하지 않아도 커뮤니티 가입은 가능하지만 개인일지 첫 저장 전에 별도 동의가 필요합니다. 동의를 철회하면 개인일지 기록을 삭제하고 개인일지 이용을 중단합니다.</p>
            <p>개인일지는 로그인한 본인 계정에서만 조회·수정·삭제할 수 있습니다. 자유입력 메모에는 AES-GCM을 적용하고, 구조화된 값은 DB 저장 암호화·TLS·접근권한·접근기록으로 보호합니다. 회사는 운영에 필요한 최소 범위 외에 원문을 공개 커뮤니티, 광고, 외부 연구 또는 AI 학습에 사용하지 않습니다.</p>
            <p>건강정보 통계 활용은 별도의 선택 동의입니다. 동의한 경우에도 최소 표본·셀 억제·반올림 정책을 적용하며, 이는 완전한 익명화를 보증하는 표현이 아닙니다.</p>
          </Section>

          <Section title="제5조 (게시물의 공개와 개인정보)">
            <p>공개 게시판에 등록한 글·댓글·이미지는 공개범위에 따라 표시됩니다. <strong>공개</strong>를 선택하면 비회원에게도 표시될 수 있고, <strong>회원 전용</strong>을 선택하면 로그인한 회원에게 표시될 수 있습니다. 비공개 게시판은 게시판 정책과 서버 권한 검사를 우선 적용합니다.</p>
          ...
          <Section title="제10조 (수사기관·준거법·문의)">
            <p>회사는 법률상 근거와 적법한 절차가 있는 경우에만 필요한 최소 범위에서 정보를 제공합니다. 웹 인증은 HttpOnly·SameSite 쿠키로 운반되는 만료 access JWT와 CSRF·Origin 검증을 사용하며, 회원의 기기·브라우저 보안까지 보증하지 않습니다. 이 약관은 대한민국 법률에 따르며 관할은 민사소송법 등 강행규정에 따릅니다.</p>
