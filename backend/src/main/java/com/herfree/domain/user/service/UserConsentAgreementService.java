...
public class UserConsentAgreementService {
    ...
    private static final String TERMS_VERSION = "2026-07-13";
    private static final String PRIVACY_VERSION = "2026-07-13";

    private final UserConsentAgreementRepository userConsentAgreementRepository;

    public void recordSignupConsent(User user, boolean ageConfirmed, boolean marketingAgreed) {
